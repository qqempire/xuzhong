                    ...
                    <div class="table2">
                        ...
                        <Modal
                            ...
                            <div :style="{width:'880px',height:'600px',display:'flex',justifyContent:'space-around',alignItems:'center'}">
                                <Carousel v-model="value1" loop=true :style="{width:'600px',height:'600px',textAlign:'center',lineHeight:'300px',border:'1px solid #cccccc'}">
                                    <CarouselItem>
                                ...
                                <ul :style="{width:'240px',height:'600px',listStyle:'none',fontSize:'14px'}">
                                    <li :style="{height:'50px',}">
                                        照片类型:&nbsp;&nbsp;<Select v-model="sortList.storelevel" :style="{width:'100px'}" filterable >
                                            <Option v-for="(item,index) in sortLists.storeLevelLists" :value="item" :key="index">{{ item }}</Option>
                                        </Select>
                                    </li>
                                    <li :style="{height:'50px',}">
                                        问题归类:&nbsp;&nbsp;<Select v-model="sortList.storelevel" :style="{width:'100px'}" filterable >
                                            <Option v-for="(item,index) in sortLists.storeLevelLists" :value="item" :key="index">{{ item }}</Option>
                                        </Select>                                            
                                    </li>
                                    ...
                                    <li :style="{height:'64px',}">
                                        地点备注<br>
                                        <Input v-model="sortList.storelevel" style="width: 200px" />                                            
                                    </li>
                                    <li :style="{height:'64px',}">
                                        问题备注<br>
                                        <Input v-model="sortList.storelevel" type="textarea" :rows="4" :style="{width:'200px',height:'60px'}" />                                             
                                    </li>
                                </ul>
                            </div> 
                        </Modal>
