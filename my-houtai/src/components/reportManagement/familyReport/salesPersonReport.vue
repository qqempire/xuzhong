...
export default {
  ...
  data () {
    return {
    // 表格内容
        columns14: [{title: '区域',key: '区域'},{title: '省份',key: '省份'},{title: '业务员',key: '业务员'},{title: '原始得分',key: '原始得分'},{title: '标准得分',key: '标准得分'},
        {title: '商店总数',key: '商店总数'},{title: 'A+店数',key: 'A'},{title: 'A店数',key: 'A'},{title: 'B店数',key: 'B店数'},{title: 'C店数',key: 'C店数'},{title: 'D店数',key: 'D店数'},
            {title: 'DSR店数',key: 'DSR店数'},{title: '样本总数',key: '样本总数'},{title: '排名',key: '排名'}],
